...
# Load model
cnn_model = tf.keras.models.load_model("dog_cat.h5")
...
def classify(model, image_path):
    ...
    label = "Normal" if prob[0][0] >= 0.5 else "Not Normal"
...
def upload_file():
    ...
    return render_template(
        "classify11.html", image_file_name=file.filename, label=label, prob=prob
    )


@app.route("/classify11/<filename>")
